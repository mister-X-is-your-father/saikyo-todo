          ...
          >
            ...
            {status === 'planning' && (
              <Button
                ...
                aria-label={
                  changing
                    ? `稼働開始 中… (Sprint「${sprint.name}」)`
                    : `稼働開始 (Sprint「${sprint.name}」)`
                }
              >
            ...
            {status === 'active' && (
              <>
                <Button
                  ...
                  aria-label={
                    changing
                      ? `完了 中… (Sprint「${sprint.name}」)`
                      : `完了 (Sprint「${sprint.name}」)`
                  }
                >
                ...
                <Button
                  ...
                  aria-label={
                    changing
                      ? `計画に戻す 中… (Sprint「${sprint.name}」)`
                      : `計画に戻す (Sprint「${sprint.name}」)`
                  }
                >
            ...
            {status !== 'cancelled' && status !== 'completed' && (
              <Button
                ...
                aria-label={
                  changing
                    ? `中止 中… (Sprint「${sprint.name}」)`
                    : `中止 (Sprint「${sprint.name}」)`
                }
              >
            ...
            {(status === 'active' || status === 'completed') && (
              <Button
                ...
                aria-label={
                  retroPending
                    ? `振り返り生成中… (Sprint「${sprint.name}」)`
                    : `振り返り生成 (Sprint「${sprint.name}」、PM Agent が完了/未完 items を要約)`
                }
              >
