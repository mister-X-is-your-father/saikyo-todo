    ...
    >
      ...
      <CardContent>
        <div
          ...
          /* iter2043: 6 entity operations group family の完成形 (sprint / sprint-period-edit /
             workflows / goals / comment-edit / integrations source operations)。Source 名 +
             enabled state + operations 構成 を sighted hover で disclose。 */
          title={`Source「${src.name}」の操作 — 現在 ${src.enabled ? '有効' : '無効'}、pull / 編集 / 有効化切替 / 削除`}
        >
